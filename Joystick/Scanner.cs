...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 48; i <= 57; ++i) start[i] = 44;
		start[77] = 1; 
		start[66] = 45; 
		start[80] = 10; 
		start[82] = 46; 
		...
		start[68] = 26; 
		start[76] = 29; 
		for (int i = 65; i <= 65; ++i) start[i] = 43;
		for (int i = 88; i <= 89; ++i) start[i] = 43;
		start[83] = 47; 
		start[Buffer.EOF] = -1;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 1:
				if (ch == 'O') {AddCh(); goto case 2;}
				else {goto case 0;}
			case 2:
				if (ch == 'V') {AddCh(); goto case 3;}
				else {goto case 0;}
			case 3:
			...
			case 12:
				if (ch == 'S') {AddCh(); goto case 13;}
				else {goto case 0;}
			case 13:
				if (ch == 'S') {AddCh(); goto case 14;}
				else {goto case 0;}
			case 14:
				{t.kind = 3; break;}
			case 15:
			...
			case 24:
				{t.kind = 5; break;}
			case 25:
				if (ch == 'P') {AddCh(); goto case 35;}
				else {goto case 0;}
			case 26:
				if (ch == 'O') {AddCh(); goto case 27;}
				else {goto case 0;}
			case 27:
				if (ch == 'W') {AddCh(); goto case 28;}
				else {goto case 0;}
			case 28:
			...
			case 45:
				...
				if (ch == 'U') {AddCh(); goto case 5;}
				else {t.kind = 7; break;}
			case 46:
				if (ch == 'E') {AddCh(); goto case 15;}
				else if (ch == 'I') {AddCh(); goto case 32;}
				else {goto case 0;}
			case 47:
